...
namespace Laurent.Lee.CLB.Net.Packet
{
    ...
    public struct TmphIcmp
    {
        ...
        {
            get { return Laurent.Lee.CLB.Unsafe.TmphMemory.GetUInt(data.Array, data.StartIndex + 8); }
        }
        ...
        {
            get { return Laurent.Lee.CLB.Unsafe.TmphMemory.GetUIntBigEndian(data.Array, data.StartIndex + 16); }
        }
        ...
        /// 源站选路(宽松TmphCode值为0x83，严格TmphCode值为0x89)，len同RR，ptr同RR。
        ...
        public TmphIcmp(TmphSubArray<byte> data)
        {
            if (data.Count >= 8)
            {
        ...
        static TmphIcmp()
        {
            ...
            minTypeSize[(int)TmphType.SourceClosed] = 8;
            minTypeSize[(int)TmphType.Redirect] = 8;
            minTypeSize[(int)TmphType.EchoRequest] = 8;
            minTypeSize[(int)TmphType.RouterAdvertisement] = 8;
            minTypeSize[(int)TmphType.RouterRequest] = 8;
            minTypeSize[(int)TmphType.Timeout] = 8;
            //minTypeSize[(int)icmpType.ParameterError] = ;
            minTypeSize[(int)TmphType.TimeRequest] = 20;
