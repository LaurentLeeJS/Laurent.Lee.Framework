...
namespace Laurent.Lee.CLB.Sql.Cache.Whole
{
        ...
        where TValueKeyType : IEquatable<TValueKeyType>
    {
        ...
        public TmphMemberDictionary(Events.TmphCache<TValueType, TModelType> cache, Func<TModelType, TKeyType> getKey, Func<TKeyType, TTargetType> getValue, Expression<Func<TTargetType, Dictionary<TValueKeyType, TValueType>>> member, Func<TModelType, TValueKeyType> getValueKey, bool isReset = true)
