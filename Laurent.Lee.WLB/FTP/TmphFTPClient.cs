...
namespace Laurent.Lee.WLB
{
    ...
    public class TmphFTPClient
    {
        ...
        /// 构造函数
        /// </summary>
        public TmphFTPClient(string remoteHost, string remotePath, string remoteUser, string remotePass, int remotePort)
        {
