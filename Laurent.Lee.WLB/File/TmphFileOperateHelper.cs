...
{
    public class TmphFileOperateHelper
    {
        #region 写文件
         ...
         *           string s = Laurent.Lee.WLB.FileOperate.GetPostfixStr(filename);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.WriteFile(Path,Strings);
        *****************************************/
         ...
         * 调用示列：
         *           string Path = Server.MapPath("Default2.aspx");
         *           string s = Laurent.Lee.WLB.FileOperate.ReadFile(Path);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.FileAdd(Path, Strings);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.FileCoppy(OrignFile, NewFile);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.FileDel(Path);
        *****************************************/
         ...
         *            Laurent.Lee.WLB.FileOperate.FileMove(OrignFile, NewFile);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.FolderCreate(OrignFolder, NewFloder);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.DeleteFolder(dir);
        *****************************************/
         ...
         *           Laurent.Lee.WLB.FileOperate.CopyDir(srcPath,aimPath);
        *****************************************/
         ...
         *           this.Literal1.Text = Laurent.Lee.WLB.FileOperate.GetFoldAll(strDirlist);
        *****************************************/
         ...
         * 调用示列：
         *            string strDirlist = Server.MapPath("templates");
         *            this.Literal2.Text = Laurent.Lee.WLB.FileOperate.GetFoldAll(strDirlist,"tpl","");
        *****************************************/
         ...
         *           Response.Write(Laurent.Lee.WLB.FileOperate.GetDirectoryLength(Path));
        *****************************************/
         ...
         *            Response.Write(Laurent.Lee.WLB.FileOperate.GetFileAttibe(file));
        *****************************************/
