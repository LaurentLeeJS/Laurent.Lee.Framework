...
namespace Laurent.Lee.WLB
{
    ...
    /// 图片检测类
    /// </summary>
    public static class TmphFileValidation
    {
        #region 上传图片检测类
        ...
        /// 是否允许
        /// </summary>
        public static bool IsAllowedExtension(HttpPostedFile oFile, TmphFileExtension[] fileEx)
        {
            ...
            br.Close();
            ms.Close();
            foreach (TmphFileExtension fe in fileEx)
            {
        ...
        public static bool IsSecureUploadPhoto(HttpPostedFile oFile)
        {
            ...
            TmphFileExtension[] fe = { TmphFileExtension.BMP, TmphFileExtension.GIF, TmphFileExtension.JPG, TmphFileExtension.PNG };
