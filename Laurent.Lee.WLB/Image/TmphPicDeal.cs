...
namespace Laurent.Lee.WLB
{
    ...
    /// 枚举,生成缩略图模式
    /// </summary>
    public enum TmphThumbnailMod : byte
    {
        /// <summary>
        /// HW
        /// </summary>
    ...
    /// 操作图片类, 生成缩略图,添加水印
    /// </summary>
    public static class TmphPicDeal
    {
        ...
        /// <returns></returns>
        public static bool MakeThumbnail(string originalImagePath, int width, int height, TmphThumbnailMod mode)
        {
            ...
            switch (mode)
            {
                case TmphThumbnailMod.HW://指定高宽缩放（可能变形）
                    break;

                case TmphThumbnailMod.W://指定宽，高按比例
                    toheight = originalImage.Height * width / originalImage.Width;
                    break;

                case TmphThumbnailMod.H://指定高，宽按比例
                    towidth = originalImage.Width * height / originalImage.Height;
                    break;

                case TmphThumbnailMod.Cut://指定高宽裁减（不变形）
