...
namespace Laurent.Lee.WLB
{
    ...
    public class TmphNetHelper
    {
        ...
        {
            //创建本地终结点
            IPEndPoint localPoint = CreateIPEndPoint(TmphNetHelper.LocalHostName, port);
        ...
        {
            //将字符串消息转换成字符数组
            byte[] buffer = TmphConvertHelper.StringToBytes(msg, Encoding.Default);
        ...
        public static string ReceiveMsg(Socket socket)
        {
            ...
            //转换成字符串，并将其返回
            return TmphConvertHelper.BytesToString(tempBuffer, Encoding.Default);
        }
