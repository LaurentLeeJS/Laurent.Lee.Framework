...
namespace Laurent.Lee.WLB
{
    ...
    /// 上传数据参数
    /// </summary>
    public class TmphUploadEventArgs : EventArgs
    {
    ...
    /// 下载数据参数
    /// </summary>
    public class TmphDownloadEventArgs : EventArgs
    {
    ...
    public class TmphWebClient
    {
        ...
        public event EventHandler<TmphUploadEventArgs> UploadProgressChanged;

        public event EventHandler<TmphDownloadEventArgs> DownloadProgressChanged;

        static TmphWebClient()
        {
            LoadCookiesFromDisk();
        }
        ...
        /// <returns></returns>
        public string Post(string url, TmphMultipartForm mulitpartForm)
        {
            HttpWebRequest request = CreateRequest(url, "POST");
        ...
        private byte[] GetData(HttpWebRequest request)
        {
            ...
            //SaveCookiesToDisk();
            TmphDownloadEventArgs args = new TmphDownloadEventArgs();
        ...
        private void PostData(HttpWebRequest request, byte[] postData)
        {
            ...
            TmphUploadEventArgs args = new TmphUploadEventArgs();
    ...
    /// </summary>
    public class TmphMultipartForm
    {
