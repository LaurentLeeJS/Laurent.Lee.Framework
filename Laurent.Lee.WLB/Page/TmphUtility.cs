...
namespace Laurent.Lee.WLB
{
    ...
    public class TmphUtility : Page
    {
        ...
        private static void SearchChild(ArrayList array, DataTable table, string columnName, string parentColumnName, string inputString, string compareString)
        {
            ...
            {
                if (TmphUtility.ToObjectString(view[index][columnName]).ToLower() == compareString.Trim().ToLower())
                {
                    array.Add("1");
                    break;
                }
                ...
                {
                    SearchChild(array, table, columnName, parentColumnName, TmphUtility.ToObjectString(view[index][columnName]), compareString);
                }
            }
        }
