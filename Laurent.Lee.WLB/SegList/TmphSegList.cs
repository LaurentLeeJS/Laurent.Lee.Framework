...
namespace Laurent.Lee.WLB
{
    ...
    public class TmphSegList
    {
        ...
        /// 按长度排序
        /// </summary>
        public void Sort(TmphSegList list)
        {
            int max = 0;
    ...
    public class Segment
    {
        ...
        public void InitWordDics()
        {
            ...
            if (GetCache("jcms_dict") == null)
            {
                ...
                while (strline != null && strline.Trim() != "")
                {
                    ...
                    {
                        list = (TmphSegList)father[strChar2];
                        if (strline.Length > 2)
                        {
                            list.Add(strline.Substring(2));
                        }
        ...
        public void OutWords()
        {
            ...
            while (idEnumerator1.MoveNext())
            {
                ...
                {
                    TmphSegList aa = (TmphSegList)idEnumerator2.Value;
