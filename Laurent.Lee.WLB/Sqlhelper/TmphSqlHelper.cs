...
namespace Laurent.Lee.WLB
{
    ...
    /// 不允许实例化，在应用时直接调用即可
    /// </summary>
    public abstract class TmphSqlHelper
    {
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        ...
        {
            return GetTable(TmphSqlHelper.connectionString, cmdTye, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(TmphSqlHelper.connectionString, cmdType, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(TmphSqlHelper.connectionString, CommandType.StoredProcedure, cmdText, commandParameters);
        }
        ...
        {
            return ExecuteScalar(TmphSqlHelper.connectionString, CommandType.Text, cmdText, commandParameters);
        }
